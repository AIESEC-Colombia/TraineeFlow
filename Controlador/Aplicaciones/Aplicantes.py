...
class Aplicantes():
    ...
    IdAPlicacion=18050181
    CodigoAPlicacion="1c5cc2ce2bc8463b826542df4d763840"
    Client=None
    ...
    def GuardarAplicante(self
        ...
        if(CiudadProyecto!="" and CiudadProyecto!=None):
